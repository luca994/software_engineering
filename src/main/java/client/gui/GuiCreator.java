...
public class GuiCreator extends Application {
	...
	public void start(Stage screen1Stage) {
		try {
			FXMLLoader loaderGUI = new FXMLLoader(getClass().getClassLoader().getResource("GUIfiles/ScreenGUI.fxml"));
		    Parent rootGUI = loaderGUI.load();
			ViewGUI view=loaderGUI.getController();
			view.startClient();
			
			FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("GUIfiles/Screen1.fxml"));
